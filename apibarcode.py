...
class GenerateBarcode:
	...
	ua = UserAgent(fallback="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36")
	...
	def get_barcode(self, code: str = "(420)14150(94)05511298370625316403") -> None:
		res = requests.post(self.url, headers=self.get_header(), data=self.get_payload(code))
		if res.ok:
